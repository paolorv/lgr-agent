...
bool waffle_agent_msgs__msg__graph_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("waffle_agent_msgs.msg._graph_result.GraphResult", full_classname_dest, 47) == 0);
  }
  waffle_agent_msgs__msg__GraphResult * ros_message = _ros_message;
  {  // node_id
...
{
  /* NOTE(esteve): Call constructor of GraphResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("waffle_agent_msgs.msg._graph_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GraphResult");

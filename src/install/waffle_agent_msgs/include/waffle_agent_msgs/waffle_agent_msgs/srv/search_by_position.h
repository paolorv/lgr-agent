...
#ifndef WAFFLE_AGENT_MSGS__SRV__SEARCH_BY_POSITION_H_
#define WAFFLE_AGENT_MSGS__SRV__SEARCH_BY_POSITION_H_
...
#endif  // WAFFLE_AGENT_MSGS__SRV__SEARCH_BY_POSITION_H_
